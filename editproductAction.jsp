...
<body>
	<%
		...
		try(Connection con = Connectionprovider.getConnection();
				PreparedStatement pdst = con.prepareStatement("update product_list set product_name = ?,purchased_qty= ?, buy_price =?, price_per_qty =?, sell_price =?, alert =? where product_id = ?;");){
